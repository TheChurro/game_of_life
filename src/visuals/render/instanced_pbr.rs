...
#[uuid = "4899fea5-87ce-43aa-97a8-4d7430283367"]
...
impl From<Color> for InstancedStandardMaterial {
...
impl From<Handle<Image>> for InstancedStandardMaterial {
...
pub struct InstancedStandardMaterialUniformData {
    /// Doubles as diffuse albedo for non-metallic, specular for metallic and a mix for everything
    /// in between.
    pub base_color: Vec4,
    // Use a color for user friendliness even though we technically don't use the alpha channel
...
impl RenderAsset for InstancedStandardMaterial {
    type ExtractedAsset = InstancedStandardMaterial;
    type PreparedAsset = GpuStandardMaterial;
    type Param = (
        SRes<RenderDevice>,
        SRes<InstancedMaterialPipeline<InstancedStandardMaterial>>,
    ...
    fn prepare_asset(
        ...
        let value = InstancedStandardMaterialUniformData {
...
impl InstancedSpecializedMaterial for InstancedStandardMaterial {
    type Key = InstancedStandardMaterialKey;
    ...
    fn fragment_shader(_asset_server: &AssetServer) -> Option<Handle<Shader>> {
        Some(bevy::pbr::PBR_SHADER_HANDLE.typed())
    }
                ...
                BindGroupLayoutEntry {
                    ...
                    ty: BindingType::Buffer {
                        ...
                        min_binding_size: BufferSize::new(
                            InstancedStandardMaterialUniformData::std140_size_static() as u64,
                        ),
                    },
                    count: None,
                },
